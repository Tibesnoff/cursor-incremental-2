...
const ResourceRow: React.FC<ResourceRowProps> = ({ name, owned, bought, multiplier, cost, canAfford, onPurchase }) => {
  return (
      ...
      <div className="grid grid-cols-5 gap-4 items-center">
        ...
        <div className="col-span-1">
          <h3 className="text-xl font-semibold text-gray-800">
            {name} <span className="text-sm text-gray-500">{formatNumber(multiplier)}x</span>
          </h3>
        </div>

        {/* Column 2: Amount */}
        <div className="col-span-1">
          <span className="text-xl font-semibold text-gray-600">{formatNumber(owned)}</span>
        </div>
